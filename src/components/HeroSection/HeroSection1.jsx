...
const WelcomePTHeroSection = () => {
    return (
        <>
            <div className="w-full relative bg-[#FFFCE0] px-4 sm:px-6 md:px-8">
                <div className="flex flex-col xl:flex-row items-center justify-between max-w-[1300px] mx-auto z-[3] relative py-8 md:py-12 xl:py-8 xl:gap-0 gap-12">
                    <div className="space-y-2 flex-1 w-full">
                        <p className="text-[#F5BB07] font-medium text-sm sm:text-[16px]">INDRODUCING INTERACTIVE</p>
                        <h1 className="text-3xl text-start sm:text-4xl md:text-5xl text-[#313D6A] font-bold z-[3] !leading-[40px] sm:!leading-[54px] md:!leading-[60px]">Learning courses by top teachers</h1>
