...
const ServiceCard = (props) => {
    return (
        <div className={'container rounded-xl mx-auto px-5 flex items-center flex-col gap-14 justify-between mb-20' + (props.reverse ? 'md:flex-row-reverse  flex-col' : 'md:flex-row')}  >
