        ...
        <li className='flex items-center gap-3 mb-2'>
            {
                index == 1 ?
                    ...
                    :
                    <span className='w-2 h-2 rounded-full bg-[#313D6A] block'></span>
            }
...
const WhyChoose = () => {
    return (
        <div className='container mx-auto px-10 mb-10 mt-32'>
            ...
            <div>
                <p className="text-center text-[20px]">Pen Tutor is a 'Network of Trained Tutors' committed to provide you highly qualified & experienced Online & Home tutoring services, individual and group sessions anywhere, anytime.
                    <br />
                    <br />
