    ...
    return (
        <DashboardBase>
            ...
            <div className="mb-3 flex items-center justify-between">
                <h3 className="text-2xl font-medium ">Posted Jobs</h3>
                <Link to='/dashboard/student/jobs/add-new/' className='bg-indigo-900 select-none max-w-max text-white py-2 px-7 block rounded-md text-lg font-bold cursor-pointer'>
                    Add Job
